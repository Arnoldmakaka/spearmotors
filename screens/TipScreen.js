			...
			<ScrollView style={{flex: 1,}} contentContainerStyle={styles.contentContainer}>
        		<KeyboardAvoidingView style={{flex: 1,}} behavior="padding">
        			<View style={{flex: 1, paddingHorizontal: 20, paddingVertical: 13,}}>
        				<Text style={{color: '#fff', textAlign: 'center', fontSize: 16 }}>How to maintain your car</Text>
        				<View style={{width: '100%', marginVertical: 5, backgroundColor: '#fff', paddingVertical: 7, paddingHorizontal: 7, borderRadius: 4,}}>
